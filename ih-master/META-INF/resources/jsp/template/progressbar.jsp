...
<script type="text/javascript" src="${application.CONTEXT_CENTRAL}/js/jquery/jquery-circleGraphic.js"></script>
<script type="text/javascript" src="${application.CONTEXT_CENTRAL}/js/jquery/jquery-canvas.js"></script>
