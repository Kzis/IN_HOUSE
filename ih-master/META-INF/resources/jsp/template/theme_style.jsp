...
<link type="text/css" rel="stylesheet" href="${application.CONTEXT_CENTRAL}/css/style/flat/flatStyle.css"/>
...
<script>
	...
	function setStyle(){
		...
		$colorTheme 	= window.parent.jQuery(".ui-state-default").css("background-color");
		$colorThemeCheckboxRadio = window.parent.jQuery(".ui-state-active").css("background-color");
		$colorThemeBorder = window.parent.jQuery(".ui-state-default").css("border-top-color");
		$colorThemeBorderCheckboxRadio = window.parent.jQuery("#dood_color_ui_state_active").css("border-top-color");
		$colorThemeTextCheckboxRadio = window.parent.jQuery(".ui-state-active").css("color");
		$colorFont 		= window.parent.jQuery(".ui-state-default").css("color");
		$colorHover 	= window.parent.jQuery(".ui-state-hover").css("background-color");
		$colorHoverBorder 	= window.parent.jQuery(".ui-state-hover").css("border-top-color");
		$bgImage 		= window.parent.jQuery(".ui-state-hover").css("background-image");
		$bgRepeat		= window.parent.jQuery(".ui-state-hover").css("background-repeat");
		$bgPosition		= window.parent.jQuery(".ui-state-hover").css("background-position");
	...
	function setRadioStyle(){
		if(theme == "maldives"){
			$colorThemeTextCheckboxRadio = "#65bdcf";
		} else if(theme == "cupertino") {
			$colorThemeTextCheckboxRadio = "";
		}
