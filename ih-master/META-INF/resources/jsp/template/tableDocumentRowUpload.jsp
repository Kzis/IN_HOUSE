...
<table id="model_<s:property value='#divresult[0]'/>" style="display: none;">
	...
	<tr class="th">
		...
		<th class="checkbox ui-state-default" style="width: 25px; display: none;">
	...
	<s:iterator value="#listAddEditData" status="statusRow" var="domain">
		...
		<s:else>
			...
			<td class="checkbox" style="width: 25px; display: none;">
						...
						<s:elseif test='#hiddenParam[1].equals("D")'>
							...
							<s:else>
								<s:textfield 
									...
									cssClass="%{#myClass} input_datepicker"
									cssStyle=""
									validName="%{getText(#hiddenParam[6])}" 
									/>
							</s:else>
							...
							<s:else>
								...
								<div style="width: 120px; float: right;">
									<input type="button" 
				                    	...
				                    	value="Browse" 
				                    	class="requireInput ui-button ui-corner-all ui-widget btnPickfiles <s:property value="#myClass"/>"
