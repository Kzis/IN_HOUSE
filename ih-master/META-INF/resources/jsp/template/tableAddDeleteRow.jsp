...
<!-- 					Arunya.k -->
	...
	<table class="RESULT_FOOTER" id="footerTable_<s:property value='#divresult[0]'/>" style="display: none">
		<tr>
			<td class="LEFT">
				<a href="javascript:void(0);" id="btnDel" onclick="deleteRow_by_elname('<s:property value="#divresult[0]"/>','tableId_<s:property value='#divresult[0]'/>');"><img src="${application.CONTEXT_CENTRAL}/images/icon/i_del.png">&nbsp;<s:text name="deleteSelect" /></a>&nbsp;&nbsp;
