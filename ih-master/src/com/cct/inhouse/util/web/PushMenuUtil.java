...
//		</li>
	...
	public PushMenuUtil(String context, Map<String, Operator> mapMenu) {
	...
	public String genarateMenuBar() {
		...
		if (mapMenuLevel.size() > 0) {
			...
			html += htmlTmp.substring(0, htmlTmp.length());
		}
		html += END_UL;
		return html;
	}
	...
	public String displayOperator(Map<String, Operator> mapMenuLevel) {
		...
		if (totalMenuInProcess == mapMenu.size()) {
