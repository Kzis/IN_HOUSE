...
public abstract class CommonSelectItemObjectServlet extends CommonSelectItemServlet {
	 ...
	 * @throws Exception
	 */
	public abstract List<CommonSelectItemObject<?>> searchSelectItem(HttpServletRequest request, CCTConnection conn, CommonUser user, Locale locale, String term, String limit) throws Exception;
	 ...
	 * @param locale
	 */
	public void responseToClient(List<CommonSelectItemObject<?>> listSelectItem, HttpServletResponse response, CommonUser user, Locale locale) {
		try {
