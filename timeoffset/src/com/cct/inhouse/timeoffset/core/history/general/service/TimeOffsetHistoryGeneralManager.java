...
public class TimeOffsetHistoryGeneralManager extends AbstractManager<HistoryGeneralSearchCriteria, HistoryGeneralSearch, Object, CommonUser, Locale> {

	private TimeOffsetHistoryGeneralService service = null;

	public TimeOffsetHistoryGeneralManager(Logger logger, CommonUser user, Locale locale) {
		super(logger, user, locale);
		this.service = new TimeOffsetHistoryGeneralService(logger, user, locale);
	}

	@Override
	public List<HistoryGeneralSearch> search(CCTConnection conn, HistoryGeneralSearchCriteria criteria) throws Exception {

		List<HistoryGeneralSearch> listResult = new ArrayList<HistoryGeneralSearch>();
		try {
	...
	public XSSFWorkbook export(CCTConnection conn, HistoryGeneralSearchCriteria criteria) throws Exception {
