...
function showNotifyMessageServerValidate(myTitle, myMessage) {
	showNotifyMessage("serverValidate", myTitle, myMessage);
}
...
function showNotifyMessage(myType, myTitle, myMessage, myError) {
	...
	if (myType == 'error') {
		...
		myTemplate +=			'<img src="' + CONTEXT_CENTRAL + '/images/icon/i_' + myType + '_message.png" />&nbsp;' + myMessage + '&nbsp;';
