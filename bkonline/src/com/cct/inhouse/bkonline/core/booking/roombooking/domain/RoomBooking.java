 ...
 *
 */
public class RoomBooking extends InhouseDomain implements Cloneable {
	...
	public RoomBooking clone() throws CloneNotSupportedException {
		return (RoomBooking) super.clone();
	}
